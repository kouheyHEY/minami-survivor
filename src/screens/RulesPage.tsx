  ...
  return (
    <main className="rules-page">
      ...
      <section className="rule-grid">
        <article><span>01</span><h2>基本移動</h2><p>手番では6面サイコロを2個振り、合計値だけ進みます。先に73マス以上へ到達したプレイヤーが即勝利です。</p></article>
        <article><span>02</span><h2>合計7 — 連鎖</h2><p>7マス進んだ後、任意で再挑戦。もう一度7ならさらに7マス進んで続行できます。失敗すると2マス戻り、手番終了です。</p></article>
