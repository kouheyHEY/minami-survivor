  ...
  return (
    <main className="rules-page">
      ...
      <section className="rule-grid">
        ...
        <article><span>03</span><h2>合計3 — 強化</h2><p>移動前に、未所持なら3種類から1つ取得。通常アイテム所持中ならSUPER化するかを選べます。選択後に3マス進みます。</p></article>
        ...
        <article><span>05</span><h2>同マス交換</h2><p>サイコロ移動で相手と同じマスに着地すると、互いの所持アイテムを交換するか選べます。</p></article>
        <article><span>06</span><h2>先手後手・順位補正</h2><p>最初にお互い2D6を振り、目が大きい人が先手か後手を選びます（同じ目なら振り直し）。後手は通常チャームを持って開始し、最初の手番だけ2D6を1回振り直せます。主移動後に2位なら、任意で1マス追加できます。</p></article>
      </section>
